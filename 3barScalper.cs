...
namespace cAlgo.Robots
{
    ...
    public class BARS_3 : Robot
    {
        ...
        private void verify_3bars_and_trade()
        {
           ...
           if (MarketSeries.Close[bars-1]>MarketSeries.Open[bars-1]) b_or_m[0]=1;//bull
           else b_or_m[0]=2;//bear
           if (MarketSeries.Close[bars-2]>MarketSeries.Open[bars-2]) b_or_m[1]=1;//bull
           else b_or_m[1]=2;//bear
           if (MarketSeries.Close[bars-3]>MarketSeries.Open[bars-3]) b_or_m[2]=1;//bull
           else b_or_m[2]=2;//bear
